...
const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Instead of passing phone in signup as name, pass name
    const name = phone; // Assuming phone field in state holds name, change accordingly if you have separate name input
    const result = await signup(email, password, name);
    if (typeof result === 'string' && result === 'user_exists') {
      setMessage('User with this email already exists. Please log in or use a different email.');
    } else if (result === true) {
